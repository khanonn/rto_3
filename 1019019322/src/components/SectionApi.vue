...
export default {
  ...
  //beforeUpdate() lo cambio por mounted solucionado para las 4 pelicuas(=.,>[@])
  mounted()//sirve para definir la funcion y traer las peliculas que siguen a continuacion
  {
    axios
